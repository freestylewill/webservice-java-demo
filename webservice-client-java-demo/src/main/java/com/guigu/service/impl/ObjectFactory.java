 ...
 * generated in the com.guigu.service.impl package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeather_QNAME = new QName("http://impl.service.guigu.com/", "queryWeather");
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://impl.service.guigu.com/", "queryWeatherResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.guigu.service.impl
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.guigu.com/", name = "queryWeather")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://impl.service.guigu.com/", name = "queryWeatherResponse")
