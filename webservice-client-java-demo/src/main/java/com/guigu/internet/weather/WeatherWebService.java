 ...
 * 
 */
@WebServiceClient(name = "WeatherWebService", targetNamespace = "http://WebXml.com.cn/", wsdlLocation = "file:/D:/WorkSpace/idea-workspace/webservice/webservice-java-demo/webservice-java-client-demo/src/main/resources/WeatherWebService.xml")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/WorkSpace/idea-workspace/webservice/webservice-java-demo/webservice-java-client-demo/src/main/resources/WeatherWebService.xml");
